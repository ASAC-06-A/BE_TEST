...
class RoadmapServiceTest {
    ...
    void delete() {
        //given
        User validUser = new User(100, "validUser", "vlidmail@gmail.com", "123456789", UserStatus.ACTIVE);
        User inValidUser = new User(101, "notValidUser", "notvlidmail@gmail.com", "123456789", UserStatus.ACTIVE);
        User inactiveUser= new User(101, "notValidUser", "notvlidmail@gmail.com", "123456789", UserStatus.INACTIVE);
